...
Define regular expressions for identifiers, digits, operators, and ignore whitespaces. Save and close the FLEX file.
Open another text file and write the BISON source file art_expr.y.
Define tokens and grammar rules to parse arithmetic expressions using +, -, *, and /. Save and close the BISON file.
Use the following commands to compile and run:
o flex art_expr.l
o bison -d art_expr.y
o gcc lex.yy.c art_expr.tab.c -o art_expr -lfl
o ./art_expr
